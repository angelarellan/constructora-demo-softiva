export const SITE = {
  ...
  whatsapp: {
    ...
    urlWithMessage:
      ...
      encodeURIComponent('Hola Construcciones Rolón, quiero pedir un presupuesto sin cargo.'),
  },
  email: 'contacto@construccionesrolon.com.ar',
  hours: [
...
export const GALLERY_IMAGES = [
  {
    ...
    alt: 'Colocación de porcelanato en obra de Construcciones Rolón, Rosario',
    label: 'Colocación de Porcelanatos',
  },
  {
    src: '/assets/construccionesrolon2.jpg',
    alt: 'Instalaciones eléctricas en interior de vivienda, Construcciones Rolón',
    label: 'Instalaciones',
  },
  {
    src: '/assets/construccionesrolon3.jpg',
    alt: 'Fachada de vivienda en construcción realizada por Construcciones Rolón',
    label: 'Fachadas',
  },
  {
    src: '/assets/construccionesrolon4.jpg',
    alt: 'Construcción de piscina en Rosario por Construcciones Rolón',
    label: 'Piscinas',
  },
  {
    src: '/assets/construccionesrolon5.jpg',
    alt: 'Casa terminada con galería y columnas, obra de Construcciones Rolón',
    label: 'Casas',
  },
]
